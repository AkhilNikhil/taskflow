...
curl -O https://raw.githubusercontent.com/AkhilNikhil/taskflow/main/docker-compose.hub.yml
curl -O https://raw.githubusercontent.com/AkhilNikhil/taskflow/main/.env.example
cp .env.example .env
